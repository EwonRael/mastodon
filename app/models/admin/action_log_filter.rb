...
class Admin::ActionLogFilter
  ...
  ACTION_TYPE_MAP = {
    ...
    change_password_user: { target_type: 'User', action: 'change_password' }.freeze,
    ...
    sleep_account: { target_type: 'Account', action: 'sleep' }.freeze,
    ...
    wake_account: { target_type: 'Account', action: 'wake' }.freeze,
